...
//                .collect(Collectors.toList());
    ...
    private void buscarSeriePorAtor() {
        System.out.println("Digite o nome do ator para buscar as séries que ele participa");
        var nomeAtor = leitura.nextLine();
        System.out.println("Avaliações a partir de qual nota?");
        var avaliacao = leitura.nextDouble();
        List<Serie> seriesEncontradas = repositorio.findByAtoresContainingIgnoreCaseAndAvaliacaoGreaterThanEqual(nomeAtor, avaliacao);
        System.out.println("Séries que o " + nomeAtor + " trabalhou.");
    ...
    private void buscarSeriesPorCategoria() {
        ...
        System.out.println("Séries da catégoria: " + nomeGenero);
    ...
    private void buscarEpisodioPorTrecho() {
        System.out.println("Qual nome do episodio para buscar? ");
